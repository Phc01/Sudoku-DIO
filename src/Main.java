...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                default -> System.out.println("Opcão Inválida, selecione uma das opções do menu");
            }
        }
    }
    ...
    private static void showCurrentGame() {
        ...
        System.out.println("Seu jogo se encontra da seguinta forma");
    ...
    private static void finishGame() {
        ...
        if (board.gameIsFinished()) {
            ...
            System.out.println("Seu jogo contém erros, verifique seu jogo.");
        } else {
